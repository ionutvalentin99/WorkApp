 ...
 */
final class Version20260330205500 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Convert user-company relationship from ManyToOne to ManyToMany, preserving existing memberships.';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        // Migrate existing memberships before dropping the column
        $this->addSql('INSERT INTO user_company (user_id, company_id) SELECT id, company_id FROM `user` WHERE company_id IS NOT NULL');
